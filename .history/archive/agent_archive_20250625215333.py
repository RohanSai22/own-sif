...
class AgentArchive:
                ...
                try:
                    ...
                    if generation_data:
                        generation = AgentGeneration(
                            ...
                            mutation_changes=generation_data.get("mutation_changes", []),
                            source_code_hash=generation_data.get("source_code_hash", ""),
    ...
    def archive_agent(
        ...
        try:
            ...
            # Get and archive source code
            source_code = agent.get_source_code()
            source_hash = self._archive_source_code(agent.agent_id, source_code)
    ...
    def get_evolution_history(self) -> List[Dict[str, Any]]:
        ...
        for generation in sorted(self.generations.values(), key=lambda g: g.created_at):
            history.append({
                ...
                "mutations_count": len(generation.mutation_changes)
            })
